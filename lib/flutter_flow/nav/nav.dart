...
class AppStateNotifier extends ChangeNotifier {
  KabapayFirebaseUser? initialUser;
  KabapayFirebaseUser? user;
  ...
  void update(KabapayFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'tokens_page',
              path: 'tokensPage',
              builder: (context, params) => TokensPageWidget(
                flowType: params.getParam('flowType', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'buy_token_page',
              path: 'buyTokenPage',
              builder: (context, params) => BuyTokenPageWidget(),
            ),
            FFRoute(
